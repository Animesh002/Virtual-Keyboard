...
def draw(img, buttonList):
    for button in buttonList:
        ...
        cvzone.cornerRect(img, (button.pos[0], button.pos[1],
                                                   button.size[0],button.size[0]), 50 ,rt=0)
        cv2.rectangle(img, button.pos, (int(x + w), int(y + h)), (51,153,255), cv2.FILLED)
        ...
        for button in buttonList:
            ...
            if x < lmList[8][0]<x+w and y < lmList[8][1] < y+h:
                ...
                if l < 35:
                    ...
                    sleep(0.20)
    cv2.rectangle(img, (40,550), (850, 650),
                  (51,153,255), cv2.FILLED)
    cv2.putText(img, final_text, (55, 620),
                cv2.FONT_HERSHEY_PLAIN, 4, (0, 0, 0), 4)
